 ...
 *
 * \param[in] p_policy Pointer handling p_policy structure.
 * \param[in] min_length A minimum number of characters of password.
 *
 * \return AUTH_PASSWD_API_SUCCESS if function call was successful. Error code otherwise.
 */
 ...
 *
 * \param[in] p_policy Pointer handling p_policy structure.
 * \param[in] val A minimum number of complex characters in password.
 *
 * \return AUTH_PASSWD_API_SUCCESS if function call was successful. Error code otherwise.
 */
...
/*
 * This API is used to diable current password policies in auth-fw.
 *
